...
public final class MainActivityTest extends BaseActivity implements CameraDialog.CameraDialogParent {
		...
		public void onCheckedChanged(final CompoundButton compoundButton, final boolean isChecked) {
			...
			case R.id.camera_button:
				if (isChecked && !mCameraHandler.isOpened()) {
					CameraDialog.showDialog(MainActivityTest.this);
				} else {
					mCameraHandler.close();
					setCameraButton(false);
				}
	...
	private final OnDeviceConnectListener mOnDeviceConnectListener = new OnDeviceConnectListener() {
		...
		public void onAttach(final UsbDevice device) {
			Toast.makeText(MainActivityTest.this, "USB_DEVICE_ATTACHED", Toast.LENGTH_SHORT).show();
		}
		...
		public void onDettach(final UsbDevice device) {
			Toast.makeText(MainActivityTest.this, "USB_DEVICE_DETACHED", Toast.LENGTH_SHORT).show();
		}
