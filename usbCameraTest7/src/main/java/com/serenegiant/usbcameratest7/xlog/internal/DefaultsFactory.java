...
package com.serenegiant.usbcameratest7.xlog.internal;

import android.content.Intent;
import android.os.Bundle;

import com.serenegiant.usbcameratest7.xlog.flattener.DefaultFlattener;
import com.serenegiant.usbcameratest7.xlog.flattener.Flattener;
import com.serenegiant.usbcameratest7.xlog.flattener.Flattener2;
import com.serenegiant.usbcameratest7.xlog.formatter.border.BorderFormatter;
import com.serenegiant.usbcameratest7.xlog.formatter.border.DefaultBorderFormatter;
import com.serenegiant.usbcameratest7.xlog.formatter.message.json.DefaultJsonFormatter;
import com.serenegiant.usbcameratest7.xlog.formatter.message.json.JsonFormatter;
import com.serenegiant.usbcameratest7.xlog.formatter.message.object.BundleFormatter;
import com.serenegiant.usbcameratest7.xlog.formatter.message.object.IntentFormatter;
import com.serenegiant.usbcameratest7.xlog.formatter.message.object.ObjectFormatter;
import com.serenegiant.usbcameratest7.xlog.formatter.message.throwable.DefaultThrowableFormatter;
import com.serenegiant.usbcameratest7.xlog.formatter.message.throwable.ThrowableFormatter;
import com.serenegiant.usbcameratest7.xlog.formatter.message.xml.DefaultXmlFormatter;
import com.serenegiant.usbcameratest7.xlog.formatter.message.xml.XmlFormatter;
import com.serenegiant.usbcameratest7.xlog.formatter.stacktrace.DefaultStackTraceFormatter;
import com.serenegiant.usbcameratest7.xlog.formatter.stacktrace.StackTraceFormatter;
import com.serenegiant.usbcameratest7.xlog.formatter.thread.DefaultThreadFormatter;
import com.serenegiant.usbcameratest7.xlog.formatter.thread.ThreadFormatter;
...
import com.serenegiant.usbcameratest7.xlog.printer.file.backup.BackupStrategy;
import com.serenegiant.usbcameratest7.xlog.printer.file.backup.FileSizeBackupStrategy;
import com.serenegiant.usbcameratest7.xlog.printer.file.clean.CleanStrategy;
import com.serenegiant.usbcameratest7.xlog.printer.file.clean.NeverCleanStrategy;
import com.serenegiant.usbcameratest7.xlog.printer.file.naming.ChangelessFileNameGenerator;
import com.serenegiant.usbcameratest7.xlog.printer.file.naming.FileNameGenerator;
